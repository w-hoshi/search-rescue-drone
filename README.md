...
Two key things to note about diagram:
...
**Autonomy was dropped.** `offboard_control` contains working PX4 offboard primitives (`takeoff_to_1m`, `forward_for_2s`) and nothing beyond them. Localization was not reliable enough to trust a closed-loop indoor mission, and drone's flight stability made it worse. All demo flights were manually piloted.
